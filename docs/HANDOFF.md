...
**阶段 1 进展：ESP32-S3 主控段 + TPS63021 电源段 + TP4056 充电/指示段 + CH340N（COM 口）+ 按键段已完成核对 + Type-C 段已画（2026-09-12 03:48 版本，84 器件 / 57 网络），Type-C 段 2 处待修。**
...
- **Type-C 段（2026-09-12 03:48 版本，84 器件/57 网络）：主体正确，2 处待修**：
  ...
  - **❌ 待修 1：U12 输出接错网**——U12.6→COM_DP、U12.4→COM_DM（J4 数据线被并进 CH340N 的 USB 总线；USB_DP/USB_DM 目前各只有 U1 一脚）。修法：U12.6 的网络标号改 **USB_DP**、U12.4 改 **USB_DM**（改标号即可，线不用动）。
  - **❌ 待修 2：缺 R10**——J3.CC1（N209，deg=1）没有下拉电阻，4 颗 CC 只放了 3 颗。补一颗 5.1 kΩ：一端 J3.CC1、一端 GND。
  - 备注：实际映射 R7=J3.CC2、R8=J4.CC1、R9=J4.CC2（电阻无极性、功能等价）；C27834 阻值待在立创商品页核对 5.1k±1%；VBUS1/VBUS2 目前为自动名 N210/N229（电气正确，可选改名）；wireCrossings=12 为视觉走线交叉，网表连接已逐项验证、不影响电气。
