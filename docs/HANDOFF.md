...
- **Type-C 段（2026-09-12 03:48 版本，84 器件/57 网络）：主体正确，2 处待修**：
  ...
  - **✅ 两处待修已解决（03:58 复核）**：① U12.6→USB_DP、U12.4→USB_DM——四条数据网络全部 deg=2 闭合：COM_DP=U10.1+U11.6、COM_DM=U10.2+U11.4、USB_DP=U1.14+U12.6、USB_DM=U1.13+U12.4；② CC 下拉 ×4 齐——用户删 R8/R9、重排为 **R6=J3.CC1、R7=J3.CC2、R11=J4.CC1、R10=J4.CC2**，全部 **C2907269**（富捷 FRC0805F5101TS，5.1 kΩ ±1% 0805，已核实）。
  - 备注：VBUS1/VBUS2 目前为自动名 N210/N229（电气正确，可选改名）；wireCrossings=12 为视觉走线交叉、不影响电气；R8/R9 位号已腾空（BOM：R8=CHRG 上拉、R9/R12=I2C 上拉）。**Type-C 段核对通过 ✓ 阶段 1 剩余：U6/U7 电池保护 + U9 MAX17048。**
