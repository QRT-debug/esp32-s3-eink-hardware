...
**阶段 1 进展：ESP32-S3 主控段 + TPS63021 电源段 + TP4056 充电/指示段已完成并核对通过（2026-09-12 00:15 版本，43 器件 / 45 网络）。**
...
- **BOM 位号需按画布重排**：画布里 U3 = TP4056，但 BOM 里 U3 = TS5A23157（音频模拟开关）——**位号冲突**，需统一。
